...
public interface Cell {
     ...
     * @return currentState (e.g. LifeState.SUSCEPTIBLE or LifeState.INFECTIOUS, or LifeState.RECOVERED in the SIR Model)
     */
    State getCurrentState();

    /**
     * Accessor for a cell's next state
     * @return nextState (e.g. LifeState.SUSCEPTIBLE or LifeState.INFECTIOUS, or LifeState.RECOVERED in the SIR Model)
     */
    State getNextState();
