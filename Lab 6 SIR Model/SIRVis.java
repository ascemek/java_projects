 ...
 */
public class SIRVis implements Vis {

    // Dimensions
    private final int windowSize = 600;   //  number of pixels along each side of the square window
    private final int cellSize;           //  number of pixels along each side of each square cell withing the window
    ...
    public static void main(String[] args) {
        ...
        //testGrid.populate( percentInfected);
